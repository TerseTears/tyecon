...
yeksared <- yeksar(..(..a = , ..b = ),
                   foo(a1 = ..a, b1 = ..b) ~ .,
                   bar(b2 = ..b, a2 = ..a) ~ .)
c(yeksared(9,5), bar(5,9))
c(yeksared(9,5,interface="bar"), foo(9,5))
...
yeksared <- yeksar(..(..a = , ..b = ),
                   foo(a1 = ..a, b1 = ..b) ~ .,
                   bar(b2 = ..b, a2 = ..a) ~ .)
c(yeksared(9,5, foo.round=FALSE), bar(5,9))
c(yeksared(9,5, foo.round=TRUE), round(bar(5,9)))
...
c(yeksared(9,5), bar(5,9)*multfactor)
...
(yeksared <- yeksar(..(..a = , ..b = ), foo(a1 = ..a, b1 = ..b) ~ .))
(yeksared <- yeksared + (bar(b2 = ..b, a2 = ..a) ~ .) +
    (baz(a3 = ..a, b3 = ..b) ~ .))
c(yeksared(9,5, interface="baz"), bar(5,9))
